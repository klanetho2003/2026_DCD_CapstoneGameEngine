...
public interface IMovable
{
    ...
    void Move(Vector2 direction, float speedWeight = 1f);
    void ForceMoveTo(Vector2 destination, float speedWeight = 1f, Action onComplete = null);
    void ForceMoveFor(Vector2 direction, float duration, float speedWeight = 1f, Action onComplete = null);
