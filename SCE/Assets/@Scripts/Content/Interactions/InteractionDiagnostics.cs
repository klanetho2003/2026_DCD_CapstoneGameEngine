...
public static class InteractionDiagnostics
{
    ...
    public static InteractionComponent Watched { get; private set; }
    public static readonly Record Current = new Record();

    public static bool IsWatching(InteractionComponent component)
    {
        return Watched != null && Watched == component;
    }

    public static void Watch(InteractionComponent component)
    {
        Watched = component;
